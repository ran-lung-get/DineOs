...
const uiDictionary: Record<string, Record<Language, string>> = {
  ...
  "ยอมรับ": { th: "ยอมรับ", en: "Accept", zh: "接受" },
  "ไม่ยอมรับ": { th: "ไม่ยอมรับ", en: "Decline", zh: "拒绝" },
  "วางไว้ที่หน้าประตู": { th: "วางไว้ที่หน้าประตู", en: "Leave at door", zh: "放在门口" },
  "เราวางอาหารไว้ให้": { th: "เราวางอาหารไว้ให้", en: "We'll leave food at your door", zh: "我们会将食物放在门口" },
  "ลงมารับเอง": { th: "ลงมารับเอง", en: "Meet in person", zh: "自取/下楼取" },
  "รับที่จุดรับอาหาร": { th: "รับที่จุดรับอาหาร", en: "Pick up at designated spot", zh: "在指定取餐点领取" },
  "ที่อยู่จัดส่ง": { th: "ที่อยู่จัดส่ง", en: "Delivery Address", zh: "配送地址" },
  "รูปแบบการรับอาหาร": { th: "รูปแบบการรับอาหาร", en: "Delivery Method", zh: "收餐方式" },
  "กรุณากรอกที่อยู่ให้ครบถ้วน (อย่างน้อย 5 ตัวอักษร)": { th: "กรุณากรอกที่อยู่ให้ครบถ้วน (อย่างน้อย 5 ตัวอักษร)", en: "Please enter full address (min 5 characters)", zh: "请填写完整地址（至少5个字符）" },
  "* กรุณาเลือกรูปแบบการรับอาหาร": { th: "* กรุณาเลือกรูปแบบการรับอาหาร", en: "* Please select a delivery method", zh: "* 请选择收餐方式" },
  ...
  "เลือกโต๊ะ": { th: "เลือกโต๊ะ", en: "Select Table", zh: "选择桌位" },
  "ผังที่นั่ง": { th: "ผังที่นั่ง", en: "Seating Layout", zh: "座位图" },
  "ว่าง": { th: "ว่าง", en: "Available", zh: "空闲" },
  "ไม่ว่าง": { th: "ไม่ว่าง", en: "Occupied", zh: "已满" },
  "เลือกแล้ว": { th: "เลือกแล้ว", en: "Selected", zh: "已选择" },
  "ไม่พบข้อมูลโต๊ะ": { th: "ไม่พบข้อมูลโต๊ะ", en: "No tables found", zh: "未找到桌位信息" },
  "ความจุ 2-4 คน": { th: "ความจุ 2-4 คน", en: "Capacity 2-4 persons", zh: "容纳2-4人" },
  "สำหรับหน้าร้าน": { th: "สำหรับหน้าร้าน", en: "Walk-in Only", zh: "仅限堂食" },
  "สำหรับ Walk-in": { th: "สำหรับ Walk-in", en: "For Walk-in", zh: "仅限直接到店" },
  "สถานะโต๊ะ:": { th: "สถานะโต๊ะ:", en: "Table Status:", zh: "桌位状态：" },
  "เลือกโต๊ะจะทำผ่านผังที่นั่ง (เปิด modal)": { th: "เลือกโต๊ะจะทำผ่านผังที่นั่ง (เปิด modal)", en: "Select table via seating layout", zh: "通过座位图选择桌号" },
  "โต๊ะที่เลือก:": { th: "โต๊ะที่เลือก:", en: "Selected Table:", zh: "已选桌号：" },
  "ยังไม่ได้เลือกโต๊ะ": { th: "ยังไม่ได้เลือกโต๊ะ", en: "No table selected yet", zh: "尚未选择桌位" },
  "เปิดผังที่นั่ง": { th: "เปิดผังที่นั่ง", en: "Open Seating Chart", zh: "打开座位图" },
  ...
  "เช่น ไม่ใส่ผัก, รสจัดพิเศษ": { th: "เช่น ไม่ใส่ผัก, รสจัดพิเศษ", en: "e.g. no veggies, extra spicy", zh: "例如：不要葱，特辣" },
  "ลดจำนวนชิ้น": { th: "ลดจำนวนชิ้น", en: "Decrease Quantity", zh: "减少数量" },
  "เพิ่มจำนวนชิ้น": { th: "เพิ่มจำนวนชิ้น", en: "Increase Quantity", zh: "增加数量" },

  // Menu Overlay
  "ไม่พบเมนูที่คุณค้นหา": { th: "ไม่พบเมนูที่คุณค้นหา", en: "No menus found", zh: "未找到相关菜单" },
  "ลองใช้คำอื่น หรือรีเซ็ตการค้นหา": { th: "ลองใช้คำอื่น หรือรีเซ็ตการค้นหา", en: "Try different keywords or reset search", zh: "请尝试其他关键词或重置搜索" },
  "ล้างคำค้นหา": { th: "ล้างคำค้นหา", en: "Clear Search", zh: "清除搜索" },
  "ล้างประวัติ": { th: "ล้างประวัติ", en: "Clear History", zh: "清空记录" },
  "ล้างประวัติการสั่งซื้อ": { th: "ล้างประวัติการสั่งซื้อ", en: "Clear Order History", zh: "清空订单记录" },
  ...
  "การดำเนินการนี้ไม่สามารถยกเลิกได้ ข้อมูลประวัติในเครื่องของคุณจะถูกลบทั้งหมด": {
    th: "การดำเนินการนี้ไม่สามารถยกเลิกได้ ข้อมูลประวัติในเครื่องของคุณจะถูกลบทั้งหมด",
    en: "This action cannot be undone. All your local order history will be deleted.",
    zh: "此操作无法撤销。您本地的所有订单记录将被全部删除。",
  },
  "ยืนยันล้างประวัติ": { th: "ยืนยันล้างประวัติ", en: "Confirm Clear", zh: "确认清空" },
  "ล้างประวัติเรียบร้อยแล้ว": { th: "ล้างประวัติเรียบร้อยแล้ว", en: "History cleared successfully", zh: "历史记录已清空" },

  // Cart Drawer
  "ตะกร้าของคุณ": { th: "ตะกร้าของคุณ", en: "Your Cart", zh: "您的购物车" },
  "ปิด": { th: "ปิด", en: "Close", zh: "关闭" },
  "ยังไม่มีรายการในตะกร้า": { th: "ยังไม่มีรายการในตะกร้า", en: "No items in cart yet", zh: "购物车暂无商品" },
  "ยอดรวม": { th: "ยอดรวม", en: "Total", zh: "总计" },

  // Order Confirmation
  "รายการสั่งซื้อในตะกร้า": { th: "รายการสั่งซื้อในตะกร้า", en: "Cart Items", zh: "购物车内商品" },
  "ตรวจสอบรายการก่อนชำระเงิน": { th: "ตรวจสอบรายการก่อนชำระเงิน", en: "Review items before checkout", zh: "结账前请核对清单" },
  "จำนวน": { th: "จำนวน", en: "Qty", zh: "数量" },
  "ชิ้น": { th: "ชิ้น", en: "pcs", zh: "份" },
  "แก้ไขรายการ": { th: "แก้ไขรายการ", en: "Edit Item", zh: "修改项目" },
  "ลบรายการ": { th: "ลบรายการ", en: "Remove Item", zh: "删除项目" },
  "ยอดรวมอาหาร": { th: "ยอดรวมอาหาร", en: "Food Subtotal", zh: "餐品小计" },
  ...
  "กรุณากรอกเบอร์โทรให้ครบ 10 หลัก": { th: "กรุณากรอกเบอร์โทรให้ครบ 10 หลัก", en: "Please enter a valid 10-digit phone number", zh: "请填写完整的10位电话号码" },
  "ชำระผ่าน Stripe": { th: "ชำระผ่าน Stripe", en: "Pay via Stripe", zh: "通过Stripe支付" },

  // Payment Overlay
  "ชำระเงินค่าอาหาร": { th: "ชำระเงินค่าอาหาร", en: "Payment", zh: "订单支付" },
  "รายการ": { th: "รายการ", en: "items", zh: "项" },
  "ค่าอาหาร (Subtotal)": { th: "ค่าอาหาร (Subtotal)", en: "Subtotal", zh: "餐品小计" },
  "ค่าจัดส่ง (Delivery Fee)": { th: "ค่าจัดส่ง (Delivery Fee)", en: "Delivery Fee", zh: "配送费" },
  "ยอดชำระทั้งหมด": { th: "ยอดชำระทั้งหมด", en: "Total Amount", zh: "实付总额" },
  "ระบบชำระเงิน Stripe (โอนเงิน/บัตรเครดิต)": { th: "ระบบชำระเงิน Stripe (โอนเงิน/บัตรเครดิต)", en: "Stripe Payment (Transfer/Credit Card)", zh: "Stripe 支付（转账/信用卡）" },
  "ชำระได้ทั้ง PromptPay QR Code และ บัตรเครดิต ผ่านแพลตฟอร์ม Stripe ที่ปลอดภัยระดับมาตรฐานสากล": { th: "ชำระได้ทั้ง PromptPay QR Code และ บัตรเครดิต ผ่านแพลตฟอร์ม Stripe ที่ปลอดภัยระดับมาตรฐานสากล", en: "Pay via PromptPay QR Code or Credit Card with world-class Stripe security.", zh: "支持 PromptPay 二维码和信用卡支付，Stripe 国际级安全保障。" },
  "ไปที่หน้าชำระเงิน Stripe": { th: "ไปที่หน้าชำระเงิน Stripe", en: "Proceed to Stripe Checkout", zh: "前往 Stripe 支付" },
  "กำลังเชื่อมต่อ Stripe...": { th: "กำลังเชื่อมต่อ Stripe...", en: "Connecting to Stripe...", zh: "正在连接 Stripe..." },
  "การชำระเงินไม่สำเร็จ": { th: "การชำระเงินไม่สำเร็จ", en: "Payment Failed", zh: "支付未成功" },
  "ตกลง": { th: "ตกลง", en: "OK", zh: "确定" },
  "ชำระเงินสำเร็จ": { th: "ชำระเงินสำเร็จ", en: "Payment Successful", zh: "支付成功" },
  ...
  "กำลังทำอาหาร": { th: "กำลังทำอาหาร", en: "Cooking", zh: "正在制作" },
  "กำลังเตรียมอาหาร": { th: "กำลังเตรียมอาหาร", en: "Preparing Food", zh: "正在备餐" },
  "พร้อมรับอาหาร": { th: "พร้อมรับอาหาร", en: "Ready for Pickup", zh: "可取餐" },
  "คนรับอาหาร/กำลังขับไป": { th: "คนรับอาหาร/กำลังขับไป", en: "Out for Delivery", zh: "骑手派送中" },
  ...
  "สั่งอาหารผิดเมนู / ลืมเพิ่มบางรายการ": { th: "สั่งอาหารผิดเมนู / ลืมเพิ่มบางรายการ", en: "Ordered wrong items / forgot items", zh: "点错菜单 / 漏选项目" },
  "รอนานเกินไป / ติดธุระด่วน": { th: "รอนานเกินไป / ติดธุระด่วน", en: "Waiting too long / urgent errand", zh: "等待时间过长 / 有急事" },
  "ใส่ที่อยู่จัดส่งผิด / ปักหมุดผิดพลาด": { th: "ใส่ที่อยู่จัดส่งผิด / ปักหมุดผิดพลาด", en: "Wrong address / pinned incorrectly", zh: "送货地址填写错误" },
  "อื่น ๆ (ระบุด้านล่าง)": { th: "อื่น ๆ (ระบุด้านล่าง)", en: "Other (specify below)", zh: "其他（在下方填写）" },
  "คิวรับอาหารกลับบ้าน": { th: "คิวรับอาหารกลับบ้าน", en: "Takeaway Queue", zh: "外带排队号" },
  "* โปรดแสดงหมายเลขคิวนี้ต่อพนักงานที่เคาน์เตอร์เพื่อรับอาหาร": { th: "* โปรดแสดงหมายเลขคิวนี้ต่อพนักงานที่เคาน์เตอร์เพื่อรับอาหาร", en: "* Please show this queue number at the counter to receive food", zh: "* 请在柜台向工作人员出示此排队号以取餐" },
  "กำลังดำเนินการคืนเงิน": { th: "กำลังดำเนินการคืนเงิน", en: "Processing Refund", zh: "正在处理退款" },
  "ยกเลิกออเดอร์สำเร็จ": { th: "ยกเลิกออเดอร์สำเร็จ", en: "Order Cancelled", zh: "订单已成功取消" },
  "ออเดอร์นี้ได้ทำการยกเลิกและคืนเงินเรียบร้อยแล้ว": { th: "ออเดอร์นี้ได้ทำการยกเลิกและคืนเงินเรียบร้อยแล้ว", en: "This order has been cancelled and refunded.", zh: "该订单已取消并完成退款。" },
  "ดูรายละเอียดสถานะทั้งหมด": { th: "ดูรายละเอียดสถานะทั้งหมด", en: "View Detailed Order Status", zh: "查看完整订单状态" },

  // History Screen
  "เริ่มสั่งอาหารเลย!": { th: "เริ่มสั่งอาหารเลย!", en: "Start Ordering Now!", zh: "立即点餐！" },
  "อาหาร": { th: "อาหาร", en: "Food", zh: "餐点" },
  "จัดส่ง": { th: "จัดส่ง", en: "Delivery", zh: "配送" },
  "รวม": { th: "รวม", en: "Total", zh: "合计" },

  // Contact & Info
  "ข้อมูลร้านค้า": { th: "ข้อมูลร้านค้า", en: "Store Information", zh: "商家信息" },
  "อาหารตามสั่ง · Street Food": { th: "อาหารตามสั่ง · Street Food", en: "Cooked to Order · Street Food", zh: "泰式热炒 · 街头美食" },
  "รีวิว": { th: "รีวิว", en: "Reviews", zh: "条评价" },
  "ที่อยู่": { th: "ที่อยู่", en: "Address", zh: "地址" },
  "88/12 ซอยสุขุมวิท 31 แขวงคลองเตยเหนือ เขตวัฒนา กรุงเทพฯ 10110": { th: "88/12 ซอยสุขุมวิท 31 แขวงคลองเตยเหนือ เขตวัฒนา กรุงเทพฯ 10110", en: "88/12 Sukhumvit 31, Khlong Toei Nuea, Watthana, Bangkok 10110", zh: "曼谷瓦塔纳区素坤逸31巷88/12号 10110" },
  "นำทาง": { th: "นำทาง", en: "Directions", zh: "导航" },
  "เวลาทำการ": { th: "เวลาทำการ", en: "Opening Hours", zh: "营业时间" },
  "อาทิตย์ - ศุกร์": { th: "อาทิตย์ - ศุกร์", en: "Sun - Fri", zh: "周日至周五" },
  "วันเสาร์": { th: "วันเสาร์", en: "Saturday", zh: "周六" },
  "ปิดทำการ": { th: "ปิดทำการ", en: "Closed", zh: "休息" },
  "รีวิวจากลูกค้า": { th: "รีวิวจากลูกค้า", en: "Customer Reviews", zh: "顾客评价" },
  "ความคิดเห็นทั้งหมด": { th: "ความคิดเห็นทั้งหมด", en: "All Reviews", zh: "全部评价" },

  // Store Closed Overlay
  "วันนี้ร้านปิดทำการ ขออภัยในความไม่สะดวก": { th: "วันนี้ร้านปิดทำการ ขออภัยในความไม่สะดวก", en: "The restaurant is closed today. Sorry for the inconvenience.", zh: "本店今日休息，给您带来不便敬请谅解。" },
  "เราจะเปิดบริการอีกครั้งวันอาทิตย์-ศุกร์": { th: "เราจะเปิดบริการอีกครั้งวันอาทิตย์-ศุกร์", en: "We will be open again Sun - Fri", zh: "我们将在周日至周五再次营业" },
  "เวลา": { th: "เวลา", en: "Hours", zh: "时间" },
  ...
  "วันนี้": { th: "วันนี้", en: "Today", zh: "今天" },
  "เข้าสู่โหมดสาธิต (Bypass เพื่อสั่งอาหาร)": { th: "เข้าสู่โหมดสาธิต (Bypass เพื่อสั่งอาหาร)", en: "Enter Demo Mode (Bypass to order)", zh: "进入演示模式（跳过以体验点餐）" },
  ...
  "บัญชีผู้ใช้": { th: "บัญชีผู้ใช้", en: "Account", zh: "用户账号" },
  ...
  "จำลองสถานะร้านปิด": { th: "จำลองสถานะร้านปิด", en: "Simulate Store Closed", zh: "模拟关店状态" },
};
